...
int Arg::parse_arg(int argc, char **argv) {
    ...
    app.add_option("-r", path_of_result, "match_result file path [default=./]")->default_val("./");
    ...
    app.add_option("--rm", result_mode, "the mode of showing match_result [time/qid] [default=time]")->default_val("time");
