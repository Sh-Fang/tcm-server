...
// 定义 JSON 转换宏
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(JsonQEdge, q_id, src_id, tar_id, e_lab, src_lab, tar_lab)
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(JsonSEdge, src_id, tar_id, e_lab, src_lab, tar_lab, timestamp)
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(AllMatchResult, all_match_result)
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(StatisticalInfo,
                                   runtime, stream_file, query_file,
                                   dataset, query_type, data_percent,
                                   total_q_edges, total_s_edges,
                                   execution_mode, result_mode,
                                   update_valid, total_update, valid_percentage,
                                   index_time, online_time, update_time, search_time,
                                   memory_use, match_count
)
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(ResponseResult,
                                   statistical_info, all_query, all_time_constraint,
                                   all_search_order, all_match_result
)